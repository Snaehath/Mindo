...
- **Gamification trap**: Streaks, coins, gems, and badges that measure _app attendance_ rather than genuine memory skill.
...
- **Memory Palace (Method of Loci)** _(6-step interactive training loop)_:
  1. _Establish Route_: Learn a 4-station home path (Front Door → Sofa → Dining Table → Bed).
  2. _Bizarre Association Drill_: Contrast mundane vs. bizarre, sensory-rich mental anchors (e.g., giant toothbrush covered in sparkly foam).
  3. _Room Placement Picker_: Actively assign an item to a specific station.
  4. _Multi-Item Palette_: Drag/assign items into empty loci slots.
  5. _Active Retrieval Test_: Mental-walk pause ("Put your phone down. Close your eyes and walk through") followed by typed retrieval.
  6. _Milestone Completion_: _"You've learned Memory Palace 🎉 — Now let's train it."_
...
- **Progressive Capability Ladder**:
  ...
  - **Level 2 (10 items)**: Building core capacity _(requires ≥80% on Level 1)_.
  - **Level 3 (15 items)**: Strong recall & multi-room navigation _(requires ≥80% on Level 2)_.
  - **Level 4 (20 items)**: Advanced challenge _(requires ≥80% on Level 3)_.
- **Focus Workout Flow**:
  ...
  - **Flexible Recall Modes**:
    - _Options Mode_: Quick recognition for beginners.
    - _Type Pro Mode_: True free-recall text entry for deliberate practice.
...
- **Technique Status Row**: Quick-glance mastery stages (_New → Learning → Building → Skilled → Strong_).
...
- **Is the transition from learning to practice seamless?** Does the user understand _why_ they are creating bizarre mental images?
